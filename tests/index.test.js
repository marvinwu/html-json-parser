...
describe('JsonFrame Tests', () => {
  ...
  describe('stopping test', () => {
    it('get first 2 ps', () => {
      ...
      let output = $('body').scrape(frame)
      expect(output).toContain({
        content: ['i am paragraph 1', 'i am paraphra 2']
      })
    })
    ...
    it('get first 2 ps', () => {
      ...
      let output = $('body').scrape(frame)
      expect(output).toContain({
        content: ['i am paragraph 1', 'i am paraphra 2', 'p3']
      })
    })
  })

  describe('breaker tests', () => {
    it('happy path', () => {
      let frame = {
        blocks: {
          _b: 'h1,h2,h3,h4',
      ...
      let output = $('#breaker').scrape(frame)
      expect(output).toContain({
        blocks: [
          {
            name: 'I love jsonframe!',
            price: ['i am paragraph 1', 'i am paraphra 2']
          },
          { name: 'i am h3', price: ['p3'] },
          { name: 'i am h4', price: ['p4', 'p4'] },
          { name: 'i am h3', price: ['p3'] }
        ]
      })
    })
    ...
    it('selection null', () => {
      ...
      let output = $('#non-exist').scrape(frame)
      expect(output).toContain({
        blocks: []
      })
    })
